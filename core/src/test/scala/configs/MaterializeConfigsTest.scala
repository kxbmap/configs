...
//      C.extract(config).exists(_ === new SubCtorsSetting(first, last, age))
//    }
//
//    val subCtor2 = forAll { (first: String, last: String) =>
//      val config = ConfigFactory.parseString(s"firstName = ${q(first)}, lastName = ${q(last)}")
//      C.extract(config).exists(_ === new SubCtorsSetting(first, last))
//    }
//
...
//           |country = ${q(country)}
//           |""".stripMargin)
//      C.extract(config).exists(_ === new SubCtorsSetting(name, age, country))
//    }
//
...
//      C.extract(config).exists(_ === MultiApply(a0, b0))
//    }
//
//    val subApply2 = forAll { a0: Int =>
//      val config = ConfigFactory.parseString(s"a0 = $a0")
//      C.extract(config).exists(_ === MultiApply(a0))
//    }
//
...
//           |b0 = $b0
//           |""".stripMargin)
//      C.extract(config).exists(_ === new MultiApply(a, b, c))
//    }
//
//    Properties.list(
...
//      val config = ConfigFactory.parseString(s"a = $a")
//      C.extract(config).exists(_ === CaseDefaults(a)()())
//    }
//
//    val caseWithSomeDefaults = forAll { (a: Int, c: Int) =>
//      val config = ConfigFactory.parseString(s"a = $a, c = $c")
//      C.extract(config).exists(_ === CaseDefaults(a)(c)())
//    }
//
//    Properties.list(
...
//        f(c).extract(config).exists(_ === new ImplicitParam(a, b)(c))
//      }
//    }
//
//    val overrideImp = {
...
//      forAll { (a: Int, b: Int, c: Int) =>
//        val config = ConfigFactory.parseString(s"a = $a, b = $b")
//        f(c).extract(config).exists(_ === new ImplicitWithDefault(a, b)(c))
//      }
//    }
//    val withoutImplicit = {
//      forAll { (a: Int, b: Int) =>
//        val config = ConfigFactory.parseString(s"a = $a, b = $b")
//        C.extract(config).exists(_ === new ImplicitWithDefault(a, b)(1))
//      }
//    }
//    Properties.list(
